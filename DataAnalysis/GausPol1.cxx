...
double GausPol1::LogLikelihood(const std::vector<double>& pars)
{
            ...
            for ( int i=x1; i<x2; i++ ) {
                    ...
                    double y_exp =  pars[0] * TMath::Gaus(i, E0, sigma_E0, true) + pars[1] + pars[2]*(i-E0); // expected value
