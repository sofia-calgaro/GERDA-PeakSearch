...
{  
    ...
    //---------------------------------------------------------------------------------------------------------------------- DATA LOADING   
    TFile *file = new TFile("/home/sofia/gerda_data/IC_20210517_BEGe.root","READ");
    //TFile *file = new TFile("/home/sofia/gerda_data/IC_20210517_Coax.root","READ");
    ...
    BCDataSet data_set;
    data_set.ReadDataFromFileTxt("/home/sofia/gerda_data/bin_content_BEGe.txt", 1);
    //data_set.ReadDataFromFileTxt("/home/sofia/gerda_data/bin_content_Coax.txt", 1);
    ...
    if ( pol_degree==0 ) {
    	    ...
    	    if ( outputK<=1 || outputK==4 || outputK==7 || outputK==13 || outputK==14 || outputK==15 || outputK==18 || outputK>=20 ) {
    	    	sprintf(name_model,"%iGausPol0", E0);
    	    }
	    else if ( outputK==2 || outputK==3 || outputK==5 || outputK==6 || outputK==12 ) {
	    	sprintf(name_model,"%iGausPol0_%gGamma", E0, E1);
	    }
	    else {
	    	sprintf(name_model,"%iGausPol0_%gGamma_%gGamma", E0, E1, E2);
	    }
	    ...
	    m.PrintSummary();
	    //m.WriteMarginalizedDistributions("/home/sofia/Analysis/DataAnalysis/Root_files/" + m.GetSafeName() + ".root", "RECREATE");
    ...
    if ( pol_degree==1 ) {
   	    ...
   	    char name_model[100];
    	    if ( outputK<=1 || outputK==4 || outputK==7 || outputK==13 || outputK==14 || outputK==15 || outputK==18 || outputK>=20 ) {
    	    	sprintf(name_model,"%iGausPol1", E0);
    	    }
	    else if ( outputK==2 || outputK==3 || outputK==5 || outputK==6 || outputK==12 ) {
	    	sprintf(name_model,"%iGausPol1_%gGamma", E0, E1);
	    }
	    else {
	    	sprintf(name_model,"%iGausPol1_%gGamma_%gGamma", E0, E1, E2);
	    }
    ...
    if ( pol_degree==2 ) {
  	    ...
  	    char name_model[100];
    	    if ( outputK<=1 || outputK==4 || outputK==7 || outputK==13 || outputK==14 || outputK==15 || outputK==18 || outputK>=20 ) {
    	    	sprintf(name_model,"%iGausPol2", E0);
    	    }
	    else if ( outputK==2 || outputK==3 || outputK==5 || outputK==6 || outputK==12 ) {
	    	sprintf(name_model,"%iGausPol2_%gGamma", E0, E1);
	    }
	    else {
	    	sprintf(name_model,"%iGausPol2_%gGamma_%gGamma", E0, E1, E2); 
	    }
