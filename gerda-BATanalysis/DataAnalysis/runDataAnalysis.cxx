...
{  
    ...
    //---------------------------------------------------------------------------------------------------------------------- DATA LOADING   
    TFile *file = new TFile("/home/sofia/gerda_data/53_93_PSD/normalized_phII_PSD.root","READ");
    //TFile *file = new TFile("/home/sofia/gerda_data/53_93_PSD/coax/20210827_coax.root","READ");
    TH1D *h = (TH1D*) file->Get("hCOAX");
    ...
    BCDataSet data_set;
    data_set.ReadDataFromFileTxt("/home/sofia/gerda_data/53_93_PSD/normalized_phII_PSD_COAX.txt", 1);
    ...
    if ( pol_degree==0 ) {
	    ...
	    m.PrintAllMarginalized("MarginalizedPDF/" + m.GetSafeName() + "_plots.pdf", 2, 2);
	    m.PrintKnowledgeUpdatePlots("Priors&Posteriors/" + m.GetSafeName() + "_plots.pdf", 2, 2);
	    m.PrintSummary();
	    m.WriteMarginalizedDistributions("MarginalizedROOT/" + std::to_string(E0) + ".root", "RECREATE");
