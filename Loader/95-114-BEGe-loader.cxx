...
int main() {
	...
	sprintf(name_rootfile, "20220%i%i_BEGe.root", 2, 15); // year / month / day
	...
	// PHASE II, II+
	std::cout << "\n Phase (II) \n TOTAL exposure BEGe (>thr; 95-114) = " << expAB_BEGe_IIp << " kg*yr" << std::endl;
        std::cout << " TOTAL exposure BEGe (<thr; 95-114) = " << expBEL_BEGe_IIp << " kg*yr" << std::endl;
        std::cout << "\n -\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-" << std::endl;
        std::cout << "\n Phase (II) \n TOTAL exposure BEGe (>thr; 95-114; yes PSD) = " << expAB_BEGe_PSD_IIp << " kg*yr" << std::endl;
        std::cout << " TOTAL exposure BEGe (<thr; 95-114; yes PSD) = " << expBEL_BEGe_PSD_IIp << " kg*yr" << std::endl;
