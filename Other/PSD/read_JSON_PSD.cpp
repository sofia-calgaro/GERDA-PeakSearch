...
int main() {
	...
	if ( ans == 1 ) {
		...
		std::string filename;
		if ( ans0==0 ) { filename = "/home/sofia/Analysis/Data2/JsonFiles/coax_PSD/JsonFile" + std::to_string(E0) + ".json"; }
		if ( ans0==1 ) { filename = "/home/sofia/Analysis/DataAnalysis/JsonFiles/BEGe_PSD/JsonFile" + std::to_string(E0) + ".json"; }
		if ( ans0==2 ) { filename = "/home/sofia/Analysis/DataAnalysis/JsonFiles/IC_PSD/JsonFile" + std::to_string(E0) + ".json"; }
	...
	if ( ans == 2 ) {
		...
		if ( ans2 == 0 ) {
				...
				for ( int j=E0_min; j<=E0_max; j++) {
					std::string filename;
					if ( ans0==0 ) { filename = "/home/sofia/Analysis/Data2/JsonFiles/coax_PSD/JsonFile" + std::to_string(j) + ".json"; }
					if ( ans0==1 ) { filename = "/home/sofia/Analysis/DataAnalysis/JsonFiles/BEGe_PSD/JsonFile" + std::to_string(j) + ".json"; }
					if ( ans0==2 ) { filename = "/home/sofia/Analysis/DataAnalysis/JsonFiles/IC_PSD/JsonFile" + std::to_string(j) + ".json"; }
					std::ifstream file(filename);
	...
	if ( ans == 0 ) {
		...
		// Peak Search
		if ( ans0==0 ) { filename1 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/PeakSearch.txt"; }
		if ( ans0==1 ) { filename1 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/PeakSearch.txt"; }
		if ( ans0==2 ) { filename1 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/PeakSearch.txt"; }
		std::ofstream file1(filename1);
		file1 << "# E0" << "\t\t" << "k" << "\t\t" << "outputK" << "\t\t" << "BKGpol" << "\t\t" << "xL" << "\t\t" << "xR" << "\t\t" << "xR-xL" << std::endl;
		
		// Parameter Ranges
		if ( ans0==0 ) { filename2 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/ParameterRanges.txt"; }
		if ( ans0==1 ) { filename2 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/ParameterRanges.txt"; }
		if ( ans0==2 ) { filename2 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/ParameterRanges.txt"; }
		...
		// Global Mode
		if ( ans0==0 ) { filename3 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/GlobalMode.txt"; }
		if ( ans0==1 ) { filename3 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/GlobalMode.txt"; }
		if ( ans0==2 ) { filename3 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/GlobalMode.txt"; }
		...
		// Mean
		if ( ans0==0 ) { filename4 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/Mean.txt"; }
		if ( ans0==1 ) { filename4 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/Mean.txt"; }
		if ( ans0==2 ) { filename4 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/Mean.txt"; }
		std::ofstream file4(filename4);
		file4 << "# E0" << std::setw(14) << "E0_count" << std::setw(15) << "sigma" << std::setw(15) << "p0" << std::setw(15) << "sigma" <<  std::setw(15) 
		<< "p1" << std::setw(15) << "sigma" << std::setw(15) << "p2" << std::setw(15) << "sigma" << std::endl;
		
		// 68% Quantile
		if ( ans0==0 ) { filename5 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/68Quantile.txt"; }
		if ( ans0==1 ) { filename5 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/68Quantile.txt"; }
		if ( ans0==2 ) { filename5 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/68Quantile.txt"; }
		...
		// 90% Upper Limit
		if ( ans0==0 ) { filename6 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/90UpperLimit.txt"; }
		if ( ans0==1 ) { filename6 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/90UpperLimit.txt"; }
		if ( ans0==2 ) { filename6 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/90UpperLimit.txt"; }
		...
		// Median
		if ( ans0==0 ) { filename7 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/Median.txt"; }
		if ( ans0==1 ) { filename7 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/Median.txt"; }
		if ( ans0==2 ) { filename7 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/Median.txt"; }
		...
		// p0 VS E0
		if ( ans0==0 ) { filename8 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/p0_VS_E0.txt"; }
		if ( ans0==1 ) { filename8 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/p0_VS_E0.txt"; }
		if ( ans0==2 ) { filename8 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/p0_VS_E0.txt"; }
		std::ofstream file8(filename8);
		//file8 << "# E0" << "\t" << "p0" << "\t" << "p0_L68sig" << "\t" << "p0_U68sig" << std::endl;
		
		// p1 VS E0
		if ( ans0==0 ) { filename9 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/p1_VS_E0.txt"; }
		if ( ans0==1 ) { filename9 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/p1_VS_E0.txt"; }
		if ( ans0==2 ) { filename9 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/p1_VS_E0.txt"; }
		std::ofstream file9(filename9);
		//file9 << "# E0" << "\t" << "p1" << "\t" << "p1_L68sig" << "\t" << "p1_U68sig" << std::endl;
		
		// p2 VS E0
		if ( ans0==0 ) { filename10 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/p2_VS_E0.txt"; }
		if ( ans0==1 ) { filename10 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/p2_VS_E0.txt"; }
		if ( ans0==2 ) { filename10 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/p2_VS_E0.txt"; }
		std::ofstream file10(filename10);
		//file10 << "# E0" << "\t" << "p2" << "\t" << "p2_L68sig" << "\t" << "p2_U68sig" << std::endl;
		
		// 90% Upper Limit - NORMALIZED
		if ( ans0==0 ) { filename11 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/90UpperLimit_norm.txt"; }
		if ( ans0==1 ) { filename11 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/90UpperLimit_norm.txt"; }
		if ( ans0==2 ) { filename11 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/90UpperLimit_norm.txt"; }
		...
		// Significance
		if ( ans0==0 ) { filename12 = "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/Significance.txt"; }
		if ( ans0==1 ) { filename12 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/Significance.txt"; }
		if ( ans0==2 ) { filename12 = "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/Significance.txt"; }
		std::ofstream file12(filename12);
		
		for ( int i=E0_min; i<=E0_max; i++) {
		
			std::string filename;
			if ( ans0==0 ) { filename = "/home/sofia/Analysis/Data2/JsonFiles/coax_PSD/JsonFile" + std::to_string(i) + ".json"; }
			if ( ans0==1 ) { filename = "/home/sofia/Analysis/DataAnalysis/JsonFiles/BEGe_PSD/JsonFile" + std::to_string(i) + ".json"; }
			if ( ans0==2 ) { filename = "/home/sofia/Analysis/DataAnalysis/JsonFiles/IC_PSD/JsonFile" + std::to_string(i) + ".json"; }
			std::ifstream file(filename);
			if ( !file ) { /*file does not exist*/ }
			else {
				json j_read;
