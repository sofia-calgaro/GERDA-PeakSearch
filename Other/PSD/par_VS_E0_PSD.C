...
int *all() {
	...
	//========================================================================================================== U90 VS E0
	if ( A==0 ) { sprintf(file_g1, "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/90UpperLimit.txt"); }	
	if ( A==1 ) { sprintf(file_g1, "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/90UpperLimit.txt"); }
	if ( A==2 ) { sprintf(file_g1, "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/90UpperLimit.txt"); }
	
	int thr=0, y_max=0;
	if ( A==0 ) { thr = 195; y_max=350; }	
	if ( A==1 ) { thr = 165; y_max = 610; }
	if ( A==2 ) { thr = 0; y_max = 160; }
	...
	/*c1->Update();
	if ( A==0 ) { c1->SaveAs("/home/sofia/Analysis/Data2/Par_VS_E0/coax_PSD/counts_VS_E0.png"); }
	if ( A==1 ) { c1->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/BEGe_PSD/counts_VS_E0.png"); }
	if ( A==2 ) { c1->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/IC_PSD/counts_VS_E0.png"); }*/
	
	//========================================================================================================== p0 VS E0
	if ( A==0 ) { sprintf(file_g2, "/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/p0_VS_E0.txt"); }	
	if ( A==1 ) { sprintf(file_g2, "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/p0_VS_E0.txt"); }
	if ( A==2 ) { sprintf(file_g2, "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/p0_VS_E0.txt"); }
	...
	g2->Draw("AP");
	/*c2->Update();
	if ( A==0 ) { c2->SaveAs("/home/sofia/Analysis/Data2/Par_VS_E0/coax_PSD/p0_VS_E0.png"); }
	if ( A==1 ) { c2->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/BEGe_PSD/p0_VS_E0.png"); }
	if ( A==2 ) { c2->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/IC_PSD/p0_VS_E0.png"); }*/
	
	ifstream file3;
	if ( A==0 ) { file3.open("/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/p1_VS_E0.txt"); }
	if ( A==1 ) { file3.open("/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/p1_VS_E0.txt"); }
	if ( A==2 ) { file3.open("/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/p1_VS_E0.txt"); }
	if ( !file3 ) { cout << "\"p1_VS_E0.txt\" does not exist"; }
		...
		g3->Draw("AP");
		/*c3->Update();
		if ( A==0 ) { c3->SaveAs("/home/sofia/Analysis/Data2/Par_VS_E0/coax_PSD/p1_VS_E0.png"); }
		if ( A==1 ) { c3->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/BEGe_PSD/p1_VS_E0.png"); }
		if ( A==2 ) { c3->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/IC_PSD/p1_VS_E0.png"); }*/
	}
	
	ifstream file4;
	if ( A==0 ) { file4.open("/home/sofia/Analysis/Data2/ReadJSON/coax_PSD/p2_VS_E0.txt"); }
	if ( A==1 ) { file4.open("/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe_PSD/p2_VS_E0.txt"); }
	if ( A==2 ) { file4.open("/home/sofia/Analysis/DataAnalysis/ReadJSON/IC_PSD/p2_VS_E0.txt"); }
	if ( !file4 ) { cout << "\"p2_VS_E0.txt\" does not exist"; }
		...
		g4->Draw("AP");
		/*c4->Update();
		if ( A==0 ) { c4->SaveAs("/home/sofia/Analysis/Data2/Par_VS_E0/coax_PSD/p2_VS_E0.png"); }
		if ( A==1 ) { c4->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/BEGe_PSD/p2_VS_E0.png"); }
		if ( A==2 ) { c4->SaveAs("/home/sofia/Analysis/DataAnalysis/Par_VS_E0/IC_PSD/p2_VS_E0.png"); }*/
	}
...
int comparison() {
	...
	if ( A==0 ) { sprintf(file_g2, "/home/sofia/Analysis/Data2/ReadJSON/coax/90UpperLimit.txt"); }	
	if ( A==1 ) { sprintf(file_g2, "/home/sofia/Analysis/DataAnalysis/ReadJSON/BEGe/90UpperLimit.txt"); }
	if ( A==2 ) { sprintf(file_g2, "/home/sofia/Analysis/DataAnalysis/ReadJSON/IC/90UpperLimit.txt"); }
	...
	if ( A==0 ) {
		auto *legend = new TLegend(.65, .75, .88, .88);
		legend->AddEntry(g1, "EnrCoax (II, II+) - 90%  upper limit + PSD", "l");
		//legend->AddEntry(line1, "Background #gamma", "l");
		legend->AddEntry(g2, "EnrCoax (II, II+) - 90%  upper limit", "l");
		TLine *line11 = new TLine(thr, 0, thr, y_max);
		line11->SetLineColor(kRed);
		line11->SetLineWidth(2);
		line11->SetLineStyle(10);
	...
	if ( A==1 ) {
		auto *legend = new TLegend(.65, .75, .88, .88);
		legend->AddEntry(g1, "EnrBEGe (II, II+) - 90%  upper limit + PSD", "l");
		//legend->AddEntry(line1, "Background #gamma", "l");
		legend->AddEntry(g2, "EnrBEGe (II, II+) - 90%  upper limit", "l");
		TLine *line11 = new TLine(thr, 0, thr, y_max);
		line11->SetLineColor(kRed);
		line11->SetLineWidth(2);
		line11->SetLineStyle(10);
	...
	if ( A==2 ) {
		auto *legend = new TLegend(.75, .75, .88, .88);
		legend->AddEntry(g1, "IC (II+) - 90%  upper limit + PSD", "l");
		legend->AddEntry(g2, "IC (II+) - 90%  upper limit", "l");
		//legend->AddEntry(line1, "Background #gamma", "l");
		legend->Draw();
	}
