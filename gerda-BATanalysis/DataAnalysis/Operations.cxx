...
double FindSigma(int energy) {
   ...
   //const double a = 0.681;   // BEGe (pre upgrade)
   //const double b = 4.27e-4; 
   //const double a = 0.551;   // BEGe 
   //const double b = 4.294e-4; 
   const double a = 1.025;   // COAX (pre upgrade)
   const double b = 6.47e-4; 
   //const double a = 0.985;   // COAX
   //const double b = 0.001073; 
...
int *FindMaximumSignalHeight(int E0, double E1, double E2, std::vector<double> bin_content, int xL, int xR, int outputK) {
...
int *FindMaximumGammaHeight1(int E0, double E1, double E2, std::vector<double> bin_content, int xL, int xR, int outputK) {
...
int *FindMaximumGammaHeight2(int E0, double E1, double E2, std::vector<double> bin_content, int xL, int xR, int outputK) {
...
double *FindRange_Pol0(int E0, std::vector<double> bin_content, int *max_height, int xL, int xR) {
...
double *FindRange_Pol1(int E0, std::vector<double> bin_content, int *max_height) {
...
double *FindRange_Pol2(int E0, std::vector<double> bin_content, int *max_height) {
...
double *FindRange_Gamma_Pol0(int E0, std::vector<double> bin_content, int *max_height, double E1, int *max_gammaYield, int xL, int xR) {
...
double *FindRange_Gamma_Pol1(int E0, std::vector<double> bin_content, int *max_height, double E1, int *max_gammaYield, int xL, int xR) {
...
double *FindRange_Gamma_Pol2(int E0, std::vector<double> bin_content, int *max_height, double E1, int *max_gammaYield, int xL, int xR) {
...
double *FindRange_TwoGamma_Pol0(int E0, std::vector<double> bin_content, int *max_height, double E1, int *max_gammaYield1, double E2, int *max_gammaYield2, int xL, int xR) {
...
double *FindRange_TwoGamma_Pol1(int E0, std::vector<double> bin_content, int *max_height, double E1, int *max_gammaYield1, double E2, int *max_gammaYield2, int xL, int xR) {
...
double *FindRange_TwoGamma_Pol2(int E0, std::vector<double> bin_content, int *max_height, double E1, int *max_gammaYield1, double E2, int *max_gammaYield2, int xL, int xR) {
