...
void JsonFile (const std::vector<double> params, const std::vector<double> params_err, int IntResults[], std::vector<double> DblResults) {
	...
	char name_file[200];
	sprintf(name_file, "JsonFiles/53_93_coax_PSD_BEGeP_re/JsonFile%i.json", E0);
	std::fstream file;
...
void Draw_Pol0(int E0, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol0.png", E0);
	c->Print(name_image);
...
void Draw_Gamma_Pol0(int E0, double EG, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol0_1Gamma.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_TwoGamma_Pol0(int E0, double EG, double EG_2, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol0_2Gamma.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_Pol1(int E0, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol1.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_Gamma_Pol1(int E0, double EG, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol1_1Gamma.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_TwoGamma_Pol1(int E0, double EG, double EG_2, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol1_2Gamma.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_Pol2(int E0, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol2.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_Gamma_Pol2(int E0, double EG, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol2_1Gamma.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
...
void Draw_TwoGamma_Pol2(int E0, double EG, double EG_2, int xL, int xR, const std::vector<double> params, TH1D *h) {
	...
	c->Update();
	char name_image[100];
	sprintf(name_image, "Plot/fit_%iGausPol2_2Gamma.png", E0);
	c->Print(name_image);
	//char name_rootfile[100];
