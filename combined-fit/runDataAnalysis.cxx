...
{  
    ...
    double eff_coax_el_II_IIp[1001][2];
    for ( int i=0; i<1001; i++ ) {
        for ( int j=0; j<2; j++ ) {
    ...
    double eff_bege_el_II_IIp[1001][2];
    for ( int i=0; i<1001; i++ ) {
        for ( int j=0; j<2; j++ ) {
    ...
    double eff_ic_el_II_IIp[1001][2];
    for ( int i=0; i<1001; i++ ) {
        for ( int j=0; j<2; j++ ) {
    ...
    /*TFile *file_2 = new TFile("/home/sofia/gerda_data/95_114_PSD/coax/20210827_BEGe.root","READ"); // DA COSTRUIRE SU lngs!!!
    TFile *file_3 = new TFile("/home/sofia/gerda_data/95_114_PSD/BEGe/20210827_BEGe.root","READ");
    TFile *file_4 = new TFile("/home/sofia/gerda_data/95_114_PSD/IC/20210827_BEGe.root","READ");*/
    ...
    vector<double> bin_content_0, bin_content_1, bin_content_2, bin_content_3, bin_content_4;
    for ( int i=1; i<=5200; i++ ) { bin_content_0.push_back( h_0->GetBinContent(i) ); }
    /*for ( int i=1; i<=5200; i++ ) { bin_content_1.push_back( h_1->GetBinContent(i) ); }
    for ( int i=1; i<=bins_2; i++ ) { bin_content_2.push_back( h_2->GetBinContent(i) ); }
    for ( int i=1; i<=bins_3; i++ ) { bin_content_3.push_back( h_3->GetBinContent(i) ); }
    for ( int i=1; i<=bins_4; i++ ) { bin_content_4.push_back( h_4->GetBinContent(i) ); }*/
    
    //---------------------------------------------------------------------------------------------------------------------- DATASET CREATION	
    // create a new dataset
    // enrCoax - phII (0-5200)
    BCDataSet data_set;
    data_set.ReadDataFromFileTxt("/home/sofia/gerda_data/53_93_PSD/coax/bin_content_PSD_coax.txt", 1); 
    ...
    for ( int i=1; i<=5200; i++ ) { // cambiare contenuto!
